                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <button onClick={() => fileRef.current?.click()} className={btnSecondary + " flex items-center gap-2"}>
                      <Camera size={15} /> {t("settings.choosePhoto")}
                    </button>
      ...
      {setupStep === "backup" && (
        <div className="space-y-4">
          <div className="flex items-center gap-2 mb-2">
            ...
            <div>
              <h4 className="text-white font-bold">{t("settings.twoFaActivated")}</h4>
              <p className="text-xs text-white/50">{t("settings.saveBackup")}</p>
            </div>
          </div>
          ...
          <div className="flex gap-2">
            ...
            >
              <Copy size={14} /> {t("settings.copyAll")}
            </button>
            <button
              onClick={() => {
