      ...
      <nav className="flex flex-col flex-1">
        ...
        const showUpdatesBadge = href === "/updates" && (counts.updates || 0) > 0;
          return (
            <Link key={href} href={href}
              ...
              <Icon size={18} className={`${iconClass} ${active ? "text-[#8b5cf6]" : "text-gray-700 dark:text-white/80 group-hover:text-emerald-600 dark:group-hover:text-emerald-300!"}`} />
        ...
        {user && (
          <Link href="/messages"
            ...
            <MessageSquare size={18} className={`${iconClass} ${pathname?.startsWith("/messages") ? "text-[#8b5cf6]" : "text-gray-700 dark:text-white/80 group-hover:text-emerald-600 dark:group-hover:text-emerald-300!"}`} />
        ...
        <button onClick={loadNotifications}
          ...
          <Bell size={18} className={`${iconClass} ${pathname === "/notifications" ? "text-[#8b5cf6]" : "text-gray-700 dark:text-white/80 group-hover:text-emerald-600 dark:group-hover:text-emerald-300!"}`} />
        ...
        {hasAdminAccess && !isDock && (
          <Link href="/adminnew"
            ...
            <ShieldAlert size={18} className={`${iconClass} ${pathname?.startsWith("/adminnew") ? "text-[#8b5cf6]" : "text-gray-700 dark:text-white/80 group-hover:text-emerald-600 dark:group-hover:text-emerald-300!"}`} />
