  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-[201] flex items-center justify-center p-4 pointer-events-none">
        <div className="w-full max-w-lg max-h-[85vh] bg-white dark:bg-[#1f1f23] border border-gray-200 dark:border-white/10 rounded-2xl shadow-2xl flex flex-col pointer-events-auto">
            ...
            <div className="p-3 border-b border-gray-200 dark:border-white/10 flex gap-1.5 flex-wrap shrink-0">
              {selectedUsers.map((u) => (
                ...
                >
                  ...
                  <button onClick={() => toggle(u.id)} className="hover:text-gray-900 dark:text-white">
                    <X size={12} />
                  </button>
                </div>
              ))}
