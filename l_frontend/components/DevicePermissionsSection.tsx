...
function PermissionRow({
  ...
  const statusKeys: Record<PermStatus, MessageKey> = {
        ...
        <div className="flex items-center gap-3 flex-1 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <div className={`inline-flex items-center gap-1.5 mt-2 px-2 py-0.5 rounded-md ${cfg.bg} ${cfg.border} border`}>
              ...
              <span className={`text-[11px] font-medium ${cfg.color}`}>{t(statusKeys[status])}</span>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 shrink-0">
          {status !== "granted" && (
            ...
            >
              ...
              {requesting ? t("perm.requesting") : t("common.enable")}
            </button>
          )}
          <button
            onClick={refresh}
  ...
  return (
    <div className="mt-3 p-4 rounded-lg bg-[#E74C3C]/5 border border-[#E74C3C]/30">
      <div className="flex items-start gap-3">
        ...
        <div>
          <p className="text-sm font-medium text-[#E74C3C]">{t("perm.deniedTitle")}</p>
