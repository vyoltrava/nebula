              ...
              {activeSubTab === "base" && (
                <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                  ...
                  <div className="pt-6 border-t border-line dark:border-white/10">
                    <span className="text-sm font-medium text-gray-300 mb-3 block">�?конка / Логотип</span>
                  ...
                  <div className="pt-4 border-t border-line dark:border-white/10">
                    ...
                    {borderGlow && (
                      <div className="space-y-2">
                         <label className="block">
                          <span className="text-xs text-gray-500 mb-1 block">�?нтенсивность</span>
                          <input
                            type="range"
                            min="0"
                            max="100"
