...
import { checkApkUpdate, isNativeApp, openApkDownload, ApkUpdateInfo } from '@/lib/appUpdate';
      ...
      <div className="rounded-2xl bg-[#8b5cf6] text-white shadow-2xl p-4 flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs text-white/70 mt-0.5">
            Текущая версия: {update.currentVersion}. Установи новый APK из релиза на GitHub.
          </p>
          <button
            onClick={() => update.apkUrl && openApkDownload(update.apkUrl)}
            className="mt-2.5 w-full sm:w-auto px-4 py-2 rounded-xl bg-white text-[#8b5cf6] text-sm font-bold active:scale-95 transition-transform"
          >
            Скачать APK
          </button>
        </div>
