  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-[251] flex items-center justify-center p-4 pointer-events-none">
        <div className="w-full max-w-sm border border-line dark:border-white/15 rounded-2xl bg-ivory dark:bg-[#1f1f23] shadow-2xl p-5 pointer-events-auto">
          ...
          <div className="space-y-2 text-xs text-gray-800 dark:text-white/80">
            <div className="p-2.5 rounded-lg bg-gray-100 dark:bg-white/5 border border-line dark:border-white/10">
