  ...
  return (
    <div className="h-screen flex overflow-hidden">
      ...
      <main className="flex-1 overflow-y-auto border-x border-gray-200 dark:border-white/10">
        <h1 className="text-2xl font-black p-4 border-b border-gray-200 dark:border-white/10 sticky top-0 bg-paper dark:bg-[#171717]/80 backdrop-blur-md text-[#8b5cf6]">
          #{tagName}
        </h1>
        {posts.map((post) => (
