...
export default function StatPage() {
  ...
  const th = (field: SortField, label: string) => (
    <th className="text-left p-3 text-gray-600 dark:text-white/50 font-bold text-xs uppercase cursor-pointer hover:text-gray-900 dark:text-white select-none whitespace-nowrap" onClick={() => handleSort(field)}>
      ...
      <div className="max-w-7xl mx-auto px-4 py-10">
        ...
        <div className="flex items-center justify-between mb-8 flex-wrap gap-4">
          <div className="flex items-center gap-4">
            <Link href="/" className="p-2 rounded-lg bg-gray-100 dark:bg-white/5 text-gray-600 dark:text-white/60 hover:text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-white/10"><ArrowLeft size={20} /></Link>
            <div>
        ...
        {activeTab === "users" && overview && (
          <div className="space-y-6">
            ...
            {/* ФИЛЬТРЫ */}
            <div className="flex gap-3 items-center p-4 bg-gray-100 dark:bg-white/5 rounded-xl border border-gray-200 dark:border-white/10 flex-wrap relative">
                      ...
                      <tr key={u.id} className="hover:bg-gray-100 dark:hover:bg-white/5 transition-colors">
                        ...
                        <td className="p-3 text-right relative">
                          <button onClick={() => setMenuUserId(menuUserId === u.id ? null : u.id)}
                            className="p-1.5 rounded-lg text-gray-600 dark:text-white/50 hover:text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-white/10">
        ...
        {activeTab === "team" && (
          <div className="space-y-6">
            ...
            {teamGroups.length === 0 ? (
              <div className="text-center py-16 border border-gray-200 dark:border-white/10 rounded-2xl bg-gray-100 dark:bg-white/5">
        ...
        <div className="fixed inset-0 bg-black/90 backdrop-blur-sm z-[400] flex items-center justify-center p-4">
          <div className="w-full max-w-5xl bg-white dark:bg-[#1f1f23] border border-gray-200 dark:border-white/15 rounded-2xl max-h-[90vh] overflow-y-auto">
            <div className="sticky top-0 bg-white dark:bg-[#1f1f23] border-b border-gray-200 dark:border-white/10 p-4 flex items-center justify-between">
              ...
              <button onClick={() => { setSelectedMember(null); setMemberStats(null); }} className="p-2 rounded-lg bg-gray-100 dark:bg-white/5 text-gray-600 dark:text-white/60 hover:text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-white/10">
                <X size={20} />
              </button>
            </div>
