"use client";
// 🤖 BOT Company переехала в BotFather-чат.
// Пользовательские боты создаются в личке с @botfather (кнопки над вводом),
  ...
  return (
    <div className="h-screen flex items-center justify-center bg-ivory dark:bg-[#18181b]">
      <p className="text-gray-500 dark:text-white/40 text-sm">
        Управление ботами переехало в чат с BotFather 🤖 — переносим…
      </p>
    </div>
  );
}