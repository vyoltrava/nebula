            ...
            <div className="relative">
              ...
              {searchQuery && (
                <button
                  ...
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-500 dark:text-white/40 hover:text-gray-900 dark:text-white transition-colors"
                >
                  <X size={18} />
                </button>
              )}
            ...
            <div className="fixed inset-0 z-[201] flex items-center justify-center p-4 pointer-events-none">
              <div className="w-full max-w-md bg-ivory dark:bg-[#1f1f23] border border-line dark:border-white/15 rounded-2xl shadow-2xl p-5 pointer-events-auto max-h-[80vh] overflow-y-auto">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <button onClick={() => setWarnTarget(null)} className="text-gray-600 dark:text-white/60 hover:text-gray-900 dark:text-white p-1">
                    <X size={18} />
                  </button>
                </div>
