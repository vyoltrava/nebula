...
if (user?.role?.color && (user?.role?.level ?? 0) >= 8) return user.role.color; // рџ†• СЂРѕР»СЊ 8-11 РїРµСЂРµРєСЂС‹РІР°РµС‚ С„Р»Р°РіРё
                ...
                <div className="space-y-4">
                  ...
                  <div className="border border-line dark:border-white/10 rounded-xl bg-gray-100 dark:bg-white/5 p-4 sm:p-5">
                    <div className="flex items-center gap-2 mb-4">
                      ...
                      <h3 className="font-bold text-gray-900 dark:text-white">Р В�РЎРѓРЎвЂљР С•РЎР‚Р С‘РЎРЏ IP-Р°РґСЂРµСЃРѕРІ</h3>
                    </div>
                    {ipHistory.length === 0 ? (
                      <p className="text-gray-600 dark:text-white/50 text-sm">Р В�РЎРѓРЎвЂљР С•РЎР‚Р С‘РЎРЏ РїСѓСЃС‚Р°</p>
                    ) : (
