...
import { PrefixesSection } from "@/components/admin/section/PrefixesSection";
...
const TABS: TabDef[] = [
  ...
  { id: "channel-badges", label: "Префиксы", icon: Megaphone, color: "#a855f7", permission: "manage_groups" },
    ...
    <div className="h-screen flex overflow-hidden bg-ivory dark:bg-[#18181b]">
      ...
      <main className="flex-1 overflow-y-auto border-x border-line dark:border-white/10">
        ...
        <div className="p-4 sm:p-6 border-b border-line dark:border-white/10 sticky top-0 bg-paper dark:bg-[#171717]/95 backdrop-blur-md z-10">
          <div className="flex items-center justify-between flex-wrap gap-3">
            ...
            <div className="flex items-center gap-1 shrink-0">
              ...
              {me.is_admin && (
                <Link href="/adminnew/payments" className={iconBtnClass} title="Оплата плашек">
                  <CreditCard size={20} />
                </Link>
              )}
        ...
        <div className="p-4 sm:p-6">
          ...
          {activeTab === "channel-badges" && <PrefixesSection me={me} />}
