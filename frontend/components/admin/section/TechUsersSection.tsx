                    ...
                    !showReset2FAConfirm ? (
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex gap-2">
                          <button onClick={resetUser2FA} disabled={resetting2FA} className="flex-1 bg-red-500 text-white font-bold rounded-lg py-2 text-sm hover:bg-red-600 disabled:opacity-40">
                            {resetting2FA ? "Сброс..." : "Подтвердить"}
                          </button>
                          <button onClick={() => setShowReset2FAConfirm(false)} disabled={resetting2FA} className="flex-1 border border-white/20 text-white/70 font-bold rounded-lg py-2 text-sm hover:bg-white/10 disabled:opacity-40">
                            Отмена
                          </button>
                        </div>
                      </div>
