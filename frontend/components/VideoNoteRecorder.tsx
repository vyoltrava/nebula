...
import { Square, X, Minimize2, Maximize2 } from "lucide-react";
      ...
      <div className="relative flex flex-col items-center">
        ...
        <div className="mt-4 text-center">
          <p className="text-white/30 text-xs font-medium">
            {isRecording ? `⏺ Запись ... ${formatTime(seconds)}` : isCameraReady ? "↓ Свернуть · ● Записать · ✕ Отменить" : "⏳ Загрузка камеры..."}
          </p>
        </div>
      </div>
    </div>
