          ...
          <div>
            ...
            <p className="text-xs text-[#B9B8BD] mt-1 leading-relaxed">
              {env.isIOS && !env.isStandalone
                ? "На iPhone уведомления работают только если добавить сайт на домашний экран (Safari → Поделиться → «На экран домой»)."
      ...
      {env.isInApp && (
        <div className="p-4 rounded-lg bg-[#F39C12]/5 border border-[#F39C12]/30">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-sm font-medium text-[#F39C12]">Встроенный браузер</p>
              <p className="text-xs text-[#B9B8BD] mt-1 leading-relaxed">
      ...
      {env.isIOS && !env.isStandalone && (
        <div className="p-4 rounded-lg bg-[#3498DB]/5 border border-[#3498DB]/30">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-sm font-medium text-[#3498DB]">iOS · Добавь на главный экран</p>
              <p className="text-xs text-[#B9B8BD] mt-1 leading-relaxed">
        ...
        {subscribed && (
          <div className="flex flex-wrap gap-2 mt-4 pt-4 border-t border-white/10">
            <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-[#2ECC71]/10 border border-[#2ECC71]/20">
              ...
              <span className="text-xs text-[#2ECC71]">Мобильный</span>
              <Check size={11} className="text-[#2ECC71]" />
            </div>
            <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-[#2ECC71]/10 border border-[#2ECC71]/20">
              <Monitor size={12} className="text-[#2ECC71]" />
              <span className="text-xs text-[#2ECC71]">Десктоп</span>
              <Check size={11} className="text-[#2ECC71]" />
            </div>
          </div>
        )}
        ...
        <div className="p-4 rounded-lg bg-[#E74C3C]/5 border border-[#E74C3C]/30">
          <div className="flex items-start gap-3">
            ...
            <div className="min-w-0 flex-1">
              <p className="text-sm font-medium text-[#E74C3C]">Ошибка</p>
      ...
      {status === "denied" && (
        <div className="p-4 rounded-lg bg-[#F39C12]/5 border border-[#F39C12]/30">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-sm font-medium text-[#F39C12]">Уведомления заблокированы</p>
              <p className="text-xs text-[#B9B8BD] mt-1 leading-relaxed">
                {env.isIOS
