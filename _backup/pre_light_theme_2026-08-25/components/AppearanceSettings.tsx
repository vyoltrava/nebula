...
export function AppearanceSettings() {
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex items-center justify-between gap-4 rounded-xl border border-gray-200 bg-white p-4 transition-colors duration-300 dark:border-white/10 dark:bg-white/[0.03]">
        <div>
