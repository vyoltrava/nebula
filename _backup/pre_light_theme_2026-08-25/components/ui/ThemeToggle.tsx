...
export function ThemeToggle({ className = "", size = 18 }: Props) {
  ...
  return (
    <button
      ...
      className={`group relative inline-flex h-10 w-10 shrink-0 items-center justify-center overflow-hidden rounded-xl border border-gray-200 bg-white text-gray-600 transition-colors duration-300 hover:bg-gray-100 active:scale-95 dark:border-white/15 dark:bg-white/5 dark:text-white/60 dark:hover:bg-white/10 ${className}`}
    >
