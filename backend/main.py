...
@app.get("/api/stickers/by-content")
...
def get_themes(
    ...
    # 🎨 Темы фонов ВСЕГДА включены: глобального выключателя больше нет.
    # Пользователь всегда сам выбирает фон в настройках (вплоть до «Стандарт»).
